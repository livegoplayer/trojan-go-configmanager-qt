...
int QConfigJsonObject::GetTheme(){
    if(this->contains(themeKey))
    {
        QJsonValue config = this->value(themeKey);
        return config.toInt();
    }
    return DEFAULT_THEME;
}

QConfigJsonObject* QConfigJsonObject::SetTheme(int value){
    this->insert(themeKey, value);
    return this;
}
